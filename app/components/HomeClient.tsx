        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          <div className="text-center mb-4">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent mb-2">
              Font Generator - Create Stylish Unicode Fonts
            </h1>
            <p className="text-sm text-gray-600 font-medium">
              Free font generator with 1000+ Unicode fonts for Instagram, Facebook, TikTok & more. Transform your text instantly with fancy, cursive, and bold styles. Copy & paste anywhere!
            </p>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-gradient-to-r from-purple-50 to-pink-50 border-t border-purple-100 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <p className="text-center text-sm text-gray-600 font-medium">
            Made with 💜 • &copy; {new Date().getFullYear()} Font Generator • Click any style to copy instantly
          </p>
        </div>
      </footer>
    </div>
